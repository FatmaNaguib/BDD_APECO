...
//	@FindBy(xpath = " //label[@for='owner_type']//following::input[1]") WebElement TypeofOwner_dll;
	...
	@FindBy(xpath ="//input[@placeholder=\"Occupation\"]") public WebElement ownerOccupationTextbox;
    ...
    //@FindBy(id = "passportNumber") public WebElement  ownerPassportNumberTextBox;
	 @FindBy(xpath = "(//input[@placeholder=\"Passport\"])[1]") public WebElement  ownerPassportNumberTextBox;
    
	@FindBy (xpath="//input[@placeholder=\"Place of Issue\"]") public WebElement passportplaceOfIssueTextBox;
	...
	@FindBy (xpath = "(//input[@placeholder=\"Passport\"])[2]") public WebElement passportUploader;
   ...
   //Owners Residence Details
	...
	@FindBy(xpath = "//input[@placeholder=\"Emirates ID\"]") public WebElement emiratesIDTextbox;
	@FindBy(xpath ="//input[@placeholder=\"Valid Emirates ID\"]") public WebElement validEmiratesIDUploader;
...
;
	...
	@FindBy(xpath ="//input[@placeholder=\"School/University\"]") public WebElement schoolandUniversitytextbox;
	...
	@FindBy (xpath ="//input[@placeholder=\"Father Name\"]") public WebElement fatherNameTextbox;
	@FindBy (xpath = "//input[@placeholder=\"Mother Name\"]") public WebElement motherNameTextbox;
	...
	@FindBy(xpath ="//input[@placeholder=\"Region\"]") public WebElement regionTextBox;
	@FindBy (xpath = "//input[@placeholder=\"Street\"]") public WebElement streetTextBox;
	...
	@FindBy(xpath = "(//button[@class='ant-btn ant-btn-primary ant-btn-lg ng-star-inserted'])[2]") public WebElement returnOwnerProfileNextButton;
